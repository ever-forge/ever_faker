defmodule Fake.Vehicle.En do
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.En.body_style()
      "Minivan"
      iex> Fake.Vehicle.En.body_style()
      "Hatchback"
      iex> Fake.Vehicle.En.body_style()
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.En.drivetrain()
      "4x2/2-wheel drive"
      iex> Fake.Vehicle.En.drivetrain()
      "4x4/4-wheel drive"
      iex> Fake.Vehicle.En.drivetrain()
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.En.make_and_model()
      "Lincoln MKZ"
      iex> Fake.Vehicle.En.make_and_model()
      "Chevrolet Malibu"
      iex> Fake.Vehicle.En.make_and_model()
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.En.model("Ford")
      "Focus"
      iex> Fake.Vehicle.En.model("BMW")
      "X5"
      iex> Fake.Vehicle.En.model("Audi")
      "A4"
      iex> Fake.Vehicle.En.model("Toyota")
      "Corolla"
  """
  ...
  def options do
    Util.list(Fake.random_between(2, 8), fn _ -> Util.pick(@options) end)
  end
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.En.standard_spec()
      "Tire pressure monitoring system (TPMS)"
      iex> Fake.Vehicle.En.standard_spec()
      "20\\" x 9.0\\" front & 20\\" x 10.0\\" rear aluminum wheels"
      iex> Fake.Vehicle.En.standard_spec()
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.En.standard_specs()
  ...
  def standard_specs do
    Util.list(Fake.random_between(2, 8), fn _ -> Util.pick(@standard_specs) end)
  end
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.En.standard_specs(3)
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.En.transmission()
      "CVT"
      iex> Fake.Vehicle.En.transmission()
      "Automatic"
      iex> Fake.Vehicle.En.transmission()
