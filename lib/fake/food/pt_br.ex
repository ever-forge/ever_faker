defmodule Fake.Food.PtBr do
  ...
  ## Examples
      ...
      iex> Fake.Food.PtBr.description()
  ...
  ## Examples
      ...
      iex> Fake.Food.PtBr.measurement()
      "Colher de Chá"
      iex> Fake.Food.PtBr.measurement()
      "Colher de Sopa"
      iex> Fake.Food.PtBr.measurement()
  ...
  ## Examples
      ...
      iex> Fake.Food.PtBr.measurement_size()
      "3"
      iex> Fake.Food.PtBr.measurement_size()
      "1/3"
      iex> Fake.Food.PtBr.measurement_size()
  ...
  ## Examples
      ...
      iex> Fake.Food.PtBr.metric_measurement()
      "centilitro"
      iex> Fake.Food.PtBr.metric_measurement()
      "decilitro"
      iex> Fake.Food.PtBr.metric_measurement()
