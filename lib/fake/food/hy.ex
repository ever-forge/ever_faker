defmodule Fake.Food.Hy do
  ...
  ## Examples
      ...
      iex> Fake.Food.Hy.measurement_size()
      "1/4"
      iex> Fake.Food.Hy.measurement_size()
      "3"
      iex> Fake.Food.Hy.measurement_size()
  ...
  ## Examples
      ...
      iex> Fake.Food.Hy.metric_measurement()
      "սանտիլիտր"
      iex> Fake.Food.Hy.metric_measurement()
      "դեցիլիտր"
      iex> Fake.Food.Hy.metric_measurement()
