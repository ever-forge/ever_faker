defmodule Fake.Person.Hy do
  ...
  ## Examples
      ...
      iex> Fake.Person.Hy.title_descriptor()
      "մարկետինգի"
      iex> Fake.Person.Hy.title_descriptor()
      "արտադրության"
      iex> Fake.Person.Hy.title_descriptor()
  ...
  ## Examples
      ...
      iex> Fake.Person.Hy.title_level()
      "ավագ"
      iex> Fake.Person.Hy.title_level()
      "առաջատար"
      iex> Fake.Person.Hy.title_level()
