defmodule Fake.Person.PtBr do
  ...
  ## Examples
      ...
      iex> Fake.Person.PtBr.first_name()
      "Augusto"
      iex> Fake.Person.PtBr.first_name()
      "Amanda"
      iex> Fake.Person.PtBr.first_name()
  ...
  ## Examples
      ...
      iex> Fake.Person.PtBr.last_name()
      "Sá"
      iex> Fake.Person.PtBr.last_name()
      "das Neves"
      iex> Fake.Person.PtBr.last_name()
