defmodule Fake.Internet.StatusCode do
  ...
  ## Examples
      ...
      iex> Fake.Internet.StatusCode.information()
      102
      iex> Fake.Internet.StatusCode.information()
      101
      iex> Fake.Internet.StatusCode.information()
  ...
  ## Examples
      ...
      iex> Fake.Internet.StatusCode.success()
      200
      iex> Fake.Internet.StatusCode.success()
      201
      iex> Fake.Internet.StatusCode.success()
  ...
  ## Examples
      ...
      iex> Fake.Internet.StatusCode.redirect()
      303
      iex> Fake.Internet.StatusCode.redirect()
      302
      iex> Fake.Internet.StatusCode.redirect()
  ...
  ## Examples
      ...
      iex> Fake.Internet.StatusCode.client_error()
      428
      iex> Fake.Internet.StatusCode.client_error()
      405
      iex> Fake.Internet.StatusCode.client_error()
  ...
  ## Examples
      ...
      iex> Fake.Internet.StatusCode.server_error()
      503
      iex> Fake.Internet.StatusCode.server_error()
      506
      iex> Fake.Internet.StatusCode.server_error()
