defmodule Fake.Finance.Stock do
  alias Fake.Util
  ...
  ## Examples
      ...
      iex> Fake.Finance.Stock.ticker(:reuters, :nikkei225)
      "2110.N225"
      iex> Fake.Finance.Stock.ticker(:reuters, :nikkei225)
      "7401.N225"
      iex> Fake.Finance.Stock.ticker(:reuters, :nikkei225)
      ...
      iex> Fake.Finance.Stock.ticker(:reuters, :nikkei225)
      "8304.N225"
      iex> Fake.Finance.Stock.ticker(:reuters, :sehk)
      "7564.HK"
      iex> Fake.Finance.Stock.ticker(:reuters, :sehk)
      "3609.HK"
      iex> Fake.Finance.Stock.ticker(:reuters, :sehk)
  ...
  def ticker(:reuters, :nikkei225) do
    "#{Fake.random_between(1000, 9999)}.N225"
  end

  def ticker(:reuters, :sehk) do
    stock_str =
      Fake.random_between(1, 8999)
      |> Integer.to_string()
