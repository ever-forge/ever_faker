defmodule Fake.Lorem do
  ...
  ## Examples
      ...
      iex> Fake.Lorem.characters(3..5)
      ~c'ppk'

      iex> Fake.Lorem.characters(2)
      ~c'Ap'

      iex> Fake.Lorem.characters(7)
      ~c'AppkQqa'
  """
  ...
  ## Examples
      ...
      iex> Fake.Lorem.sentence()
      "Sint deleniti consequatur et qui vitae et quibusdam et sit."
      iex> Fake.Lorem.sentence(2..3)
      "Cumque est?"
      iex> Fake.Lorem.sentence(3)
      "Beatae ex sunt."
      iex> Fake.Lorem.sentence(5)
  ...
  ## Examples
      ...
      iex> Fake.Lorem.sentence(7, "...")
      "Aliquam ut sint deleniti consequatur et qui..."
      iex> Fake.Lorem.sentence(1, "?")
      "Vitae?"
      iex> Fake.Lorem.sentence(5, ".")
  ...
  ## Examples
      ...
      iex> Fake.Lorem.words()
      ["ut", "sint", "deleniti", "consequatur", "et"]
      iex> Fake.Lorem.words(1..2)
      ["vitae"]
      iex> Fake.Lorem.words(2)
      ["et", "quibusdam"]
      iex> Fake.Lorem.words(6)
  ...
  defp character do
    ...
    Enum.at(alphabet, Fake.random_between(0, Enum.count(alphabet) - 1))
  end
end
