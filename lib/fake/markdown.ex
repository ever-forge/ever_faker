defmodule Fake.Markdown do
  import Fake, only: [random_between: 2, random_uniform: 0]
  ...
  ## Examples
      ...
      iex> Fake.Markdown.ordered_list()
  ...
  ## Examples
      ...
      iex> Fake.Markdown.unordered_list()
