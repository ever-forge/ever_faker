defmodule Fake.Code.Iban do
  ...
  ## Examples
      ...
      iex> Fake.Code.Iban.iban
      "GI88LRCE6SQ3CQJGP3UHAJD"
      iex> Fake.Code.Iban.iban("NL")
      "NL26VYOC3032097337"
      iex> Fake.Code.Iban.iban(["NL", "BE"])
      "NL74YRFX4598109960"
      iex> Fake.Code.Iban.iban(["NL", "BE"])
      "BE31198979502980"
  """
  ...
  ## Examples
      ...
      iex> Fake.Code.Iban.iban("FR")
      "FR650154264610QJGP3UHAJDJ02"
      iex> Fake.Code.Iban.iban("BE")
      "BE95030320973376"
      iex> Fake.Code.Iban.iban(["NL", "BE"])
      "NL31RFXY5981099607"
      iex> Fake.Code.Iban.iban(["BE", "DE"])
  ...
  ## Examples
      ...
      iex> Fake.Code.Iban.iban("NL", ["ABNA"])
      "NL16ABNA0154264610"
      iex> Fake.Code.Iban.iban("MC", ["FOO", "BAR"])
      "MC98FOOBAR83"
      iex> Fake.Code.Iban.iban("SM", ["A"])
  ...
  defp sample(list) do
    Enum.fetch!(list, Fake.random_between(0, length(list) - 1))
  end
end
