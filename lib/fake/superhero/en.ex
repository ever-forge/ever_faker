defmodule Fake.Superhero.En do
  ...
  defp name(n) when is_integer(n), do: "#{descriptor()}"
  ...
  ## Examples
      ...
      iex> Fake.Superhero.En.descriptor()
      "Ronin"
      iex> Fake.Superhero.En.descriptor()
      "Azrael"
      iex> Fake.Superhero.En.descriptor()
