defmodule Fake.Commerce.PtBr do
  ...
  alias Fake.Color.PtBr, as: Color
  ...
  ## Examples
      ...
      iex> Fake.Commerce.PtBr.department()
  ...
  ## Examples
      ...
      iex> Fake.Commerce.PtBr.product_name()
  ...
  def product_name, do: product_name(Fake.random_between(0, 5))
  ...
  ## Examples
      ...
      iex> Fake.Commerce.PtBr.product_name_adjective()
      "Gigante"
      iex> Fake.Commerce.PtBr.product_name_adjective()
      "Rústico(a)"
      iex> Fake.Commerce.PtBr.product_name_adjective()
  ...
  ## Examples
      ...
      iex> Fake.Commerce.PtBr.product_name_material()
      "Plástico"
      iex> Fake.Commerce.PtBr.product_name_material()
      "Aço"
      iex> Fake.Commerce.PtBr.product_name_material()
  ...
  ## Examples
      ...
      iex> Fake.Commerce.PtBr.product_name_product()
      "Guarda-roupa"
      iex> Fake.Commerce.PtBr.product_name_product()
      "Cadeira"
      iex> Fake.Commerce.PtBr.product_name_product()
