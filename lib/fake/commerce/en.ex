defmodule Fake.Commerce.En do
  ...
  ## Examples
      ...
      iex> Fake.Commerce.En.department()
      "Home, Garden & Tools"
      iex> Fake.Commerce.En.department()
  ...
  ## Examples
      ...
      iex> Fake.Commerce.En.product_name()
  ...
  ## Examples
      ...
      iex> Fake.Commerce.En.product_name_adjective()
      "Small"
      iex> Fake.Commerce.En.product_name_adjective()
      "Ergonomic"
      iex> Fake.Commerce.En.product_name_adjective()
  ...
  ## Examples
      ...
      iex> Fake.Commerce.En.product_name_material()
      "Rubber"
      iex> Fake.Commerce.En.product_name_material()
      "Concrete"
      iex> Fake.Commerce.En.product_name_material()
  ...
  ## Examples
      ...
      iex> Fake.Commerce.En.product_name_product()
      "Gloves"
      iex> Fake.Commerce.En.product_name_product()
      "Computer"
      iex> Fake.Commerce.En.product_name_product()
