defmodule Fake.Phone.EnGb do
  ...
  ## Examples
      ...
      iex> Fake.Phone.EnGb.landline_number()
      "+44335426461"
      iex> Fake.Phone.EnGb.landline_number()
      "+44343297052"
      iex> Fake.Phone.EnGb.landline_number()
  ...
  ## Examples
      ...
      iex> Fake.Phone.EnGb.cell_number()
      "+447415 426461"
      iex> Fake.Phone.EnGb.cell_number()
      "07483 297052"
      iex> Fake.Phone.EnGb.cell_number()
  ...
  ## Examples
      ...
      iex> Fake.Phone.EnGb.mobile_number()
      "+447415 426461"
      iex> Fake.Phone.EnGb.mobile_number()
      "07483 297052"
      iex> Fake.Phone.EnGb.mobile_number()
  ...
  defp random_numbers_until(out, count) do
    ...
    "#{out}#{Fake.format(format)}"
  end

  defp number_prefix do
    numbers = Map.values(@prefixes)
    type = Enum.at(numbers, Fake.random_between(0, Enum.count(@prefixes) - 1))
    Enum.at(type, Fake.random_between(0, Enum.count(type) - 1))
  end
end
