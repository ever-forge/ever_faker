defmodule Fake.Phone.EnUs do
  ...
  ## Examples
      ...
      iex> Fake.Phone.EnUs.exchange_code()
      "503"
      iex> Fake.Phone.EnUs.exchange_code()
      "845"
      iex> Fake.Phone.EnUs.exchange_code()
  ...
  ## Examples
      ...
      iex> Fake.Phone.EnUs.subscriber_number()
      "0154"
      iex> Fake.Phone.EnUs.subscriber_number()
      "2646"
      iex> Fake.Phone.EnUs.subscriber_number(2)
      "10"
      iex> Fake.Phone.EnUs.subscriber_number(5)
      "83297"
  """
  @spec subscriber_number(pos_integer) :: String.t()
  def subscriber_number(n) when is_integer(n) do
    Fake.format(String.duplicate("#", n))
  end
  ...
  ## Examples
      ...
      iex> Fake.Phone.EnUs.extension()
      "0154"
      iex> Fake.Phone.EnUs.extension()
      "2646"
      iex> Fake.Phone.EnUs.extension(3)
      "108"
      iex> Fake.Phone.EnUs.extension(5)
      "32970"
  """
  defdelegate extension(n), to: __MODULE__, as: :subscriber_number
  defdelegate extension, to: __MODULE__, as: :subscriber_number

  defp std_separator, do: Enum.at(["-", ".", ""], Fake.random_between(0, 2))

  defp digit(min, max), do: Fake.random_between(min, max)
end
