defmodule Fake.Phone.PtBr do
  ...
  ## Examples
      ...
      iex> Fake.Phone.PtBr.number_with_region("(xx) 9 1542-6461")
      "(92) 9 1542-6461"
      iex> Fake.Phone.PtBr.number_with_region("(xx) 4329-7052")
      "(31) 4329-7052"
      iex> Fake.Phone.PtBr.number_with_region("(xx) 9 7020-3032")
      "(71) 9 7020-3032"
      iex> Fake.Phone.PtBr.number_with_region("(xx) 5733-7603")
      "(71) 5733-7603"
  """
  ...
  ## Examples
      ...
      iex> Fake.Phone.PtBr.generate_region_code()
      "92"
      iex> Fake.Phone.PtBr.generate_region_code()
      "31"
      iex> Fake.Phone.PtBr.generate_region_code()
