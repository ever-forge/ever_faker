defmodule Fake.Avatar do
  ...
  ## Examples
      ...
      iex> Fake.Avatar.image_url("elixir")
      "https://robohash.org/elixir"
      iex> Fake.Avatar.image_url("plug")
      "https://robohash.org/plug"
      iex> Fake.Avatar.image_url("ecto")
  ...
  ## Examples
      ...
      iex> Fake.Avatar.image_url("phoenix", 100, 100)
      "https://robohash.org/phoenix?size=100x100"
      iex> Fake.Avatar.image_url("haskell", 200, 200)
      "https://robohash.org/haskell?size=200x200"
      iex> Fake.Avatar.image_url("ocaml", 300, 300)
      "https://robohash.org/ocaml?size=300x300"
      iex> Fake.Avatar.image_url("idris", 400, 400)
