defmodule Fake.File do
  ...
  ## Examples
      ...
      iex> Fake.File.file_extension(:video)
      "mov"
      iex> Fake.File.file_extension(:image)
      "tiff"
      iex> Fake.File.file_extension(:audio)
      "flac"
      iex> Fake.File.file_extension(:office)
      "xls"
  """
  ...
  ## Examples
      ...
      iex> Fake.File.file_name(:text)
      "aliquam.txt"
      iex> Fake.File.file_name(:video)
      "sint.mp4"
      iex> Fake.File.file_name(:image)
      "consequatur.bmp"
      iex> Fake.File.file_name(:audio)
      "qui.wav"
  """
  ...
  ## Examples
      ...
      iex> Fake.File.mime_type(:image)
      "image/vnd.microsoft.icon"
      iex> Fake.File.mime_type(:audio)
      "audio/mp4"
      iex> Fake.File.mime_type(:application)
      "application/xop+xml"
      iex> Fake.File.mime_type(:video)
      "video/mpeg"
  """
  ...
  defp pick(list) do
    list
    |> Enum.at(Fake.random_between(0, Enum.count(list) - 1))
  end
end
