defmodule Fake.Vehicle do
  import Fake, only: [localize: 1]
  alias Fake.Util
  alias Fake.Vehicle.En
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.make_and_model()
      "Lincoln MKZ"
      iex> Fake.Vehicle.make_and_model()
      "Chevrolet Malibu"
      iex> Fake.Vehicle.make_and_model()
  ...
  ## Examples
      iex> Fake.Vehicle.model("Ford")
      "Focus"
      iex> Fake.Vehicle.model("BMW")
      "X5"
      iex> Fake.Vehicle.model("Audi")
      "A4"
      iex> Fake.Vehicle.model("Toyota")
      "Corolla"
  """
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.standard_spec()
  ...
  ## Examples
      ...
      iex> Fake.Vehicle.standard_specs()
