defmodule Fake.Nato do
  ...
  ## Examples
      ...
      iex> Fake.Nato.letter_code_word()
      "ECHO"
      iex> Fake.Nato.letter_code_word()
      "LIMA"
      iex> Fake.Nato.letter_code_word()
