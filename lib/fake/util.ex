defmodule Fake.Util do
  ...
  ## Examples
      ...
      iex> Fake.Util.pick(10..100)
      79
      iex> Fake.Util.pick([1, 3, 5, 7])
      3
      iex> Fake.Util.pick([true, false, nil])
      true
      iex> Fake.Util.pick(["a", "b", "c"], ["b"])
      "a"
      iex> Fake.Util.pick([1, "2", 3.0], 1..10)
      "2"
  """
  ...
  def pick(enum) do
    Enum.at(enum, Fake.random_between(0, Enum.count(enum) - 1))
  end
  ...
  ## Examples
      ...
      iex> Fake.Util.sample_uniq(2, &Fake.Internet.email/0)
      ["conor2058@schiller.com", "elizabeth2056@rolfson.net"]
      iex> Fake.Util.sample_uniq(10, fn -> Fake.String.base64(4) end)
      [
        "0CzJ",
        "3nuk",
        "D1Ip",
      ...
      iex> Fake.Util.sample_uniq(1, &Fake.Phone.EnUs.area_code/0)
      ["508"]
      iex> Fake.Util.sample_uniq(0, &Fake.Internet.email/0)
      ** (FunctionClauseError) no function clause matching in Fake.Util.sample_uniq/3
  """
  ...
  ## Examples
      ...
      iex> Fake.Util.list(3, &(&1))
      [0, 1, 2]
      iex> Fake.Util.list(3, &(&1 + 1))
      [1, 2, 3]
      iex> Fake.Util.list(5, &(&1 * &1))
      [0, 1, 4, 9, 16]
      iex> Fake.Util.list(3, &(to_string(&1)))
      ["0", "1", "2"]
  """
  ...
  ## Examples
      ...
      iex> Fake.Util.join(3, ", ", &Fake.Code.isbn13/0)
      "9781542646109, 9783297052358, 9790203032090"
      iex> Fake.Util.join(4, "-", fn -> Fake.format("####") end)
      "7337-6033-7459-8109"
      iex> Fake.Util.join(2, " vs ", &Fake.Superhero.name/0)
      "Falcon vs Green Blink Claw"
      iex> Fake.Util.join(2, " or ", &Fake.Color.name/0)
      "Purple or White"
  """
  ...
  ## Examples
      ...
      iex> Fake.Util.to_sentence(["Black", "White"])
      "Black and White"
      iex> Fake.Util.to_sentence(["Jon Snow"])
      "Jon Snow"
      iex> Fake.Util.to_sentence(["Oceane", "Angeline", "Nicholas"])
      "Angeline, Nicholas, and Oceane"
      iex> Fake.Util.to_sentence(["One", "Two", "Three", "Four"])
      "Two, Three, Four, and One"
  """
  @spec to_sentence([binary]) :: binary
  def to_sentence(items) do
    Module.concat(__MODULE__, Fake.mlocale()).to_sentence(items)
  end
  ...
  ## Examples
      ...
      iex> Fake.Util.format("%2d-%3d %a%A %2d%%")
      "01-542 aS 61%"
      iex> Fake.Util.format("%8nBATMAN", n: fn() -> "nana " end)
