defmodule Fake.Address.Es do
  import Fake, only: [sampler: 2]

  alias Fake.Person.Es
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.building_number()
      "s/n."
      iex> Fake.Address.Es.building_number()
      "5"
      iex> Fake.Address.Es.building_number()
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.city_prefix()
      "Vitoria"
      iex> Fake.Address.Es.city_prefix()
      "Oviedo"
      iex> Fake.Address.Es.city_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.country_code()
      "ES"
  """
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.secondary_address()
      "Esc. 154"
      iex> Fake.Address.Es.secondary_address()
      "Esc. 646"
      iex> Fake.Address.Es.secondary_address()
  ...
  @doc """
  Return state. But Spain doesn't have states so this calls Fake.Address.Es.region() instead.
  """
  @spec state() :: String.t()
  def state, do: region()
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.state_abbr()
      "Ara"
      iex> Fake.Address.Es.state_abbr()
      "Cbr"
      iex> Fake.Address.Es.state_abbr()
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.street_address()
      "Arrabal Daniela 26"
      iex> Fake.Address.Es.street_address()
      "Mercado Navarro s/n."
      iex> Fake.Address.Es.street_address()
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.street_address(true)
      "Arrabal Daniela 26 Esc. 610"
      iex> Fake.Address.Es.street_address(false)
      "Parque Débora Huerta 05"
      iex> Fake.Address.Es.street_address(false)
      "Rambla Gutiérrez 02"
      iex> Fake.Address.Es.street_address(false)
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.street_name()
      "Arrabal Daniela"
      iex> Fake.Address.Es.street_name()
  ...
  ## Examples
      iex> Fake.Address.Es.street_suffix()
      "de arriba"
      iex> Fake.Address.Es.street_suffix()
      "Sur"
      iex> Fake.Address.Es.street_suffix()
  ...
  ## Examples
      ...
      iex> Fake.Address.Es.street_prefix()
      "Carretera"
      iex> Fake.Address.Es.street_prefix()
      "Arrabal"
      iex> Fake.Address.Es.street_prefix()
