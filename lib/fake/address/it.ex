defmodule Fake.Address.It do
  import Fake, only: [sampler: 2]

  alias Fake.Address.It
  ...
  ## Examples
      ...
      iex> Fake.Address.It.building_number()
      "154"
      iex> Fake.Address.It.building_number()
      "64"
      iex> Fake.Address.It.building_number()
  ...
  def building_number do
    ["###", "##", "#"]
    |> Enum.at(Fake.random_between(0, 2))
    |> Fake.format()
  end
  ...
  @spec city() :: String.t()
  def city do
    city(Fake.random_between(0, 3))
  end

  defp city(0), do: "#{city_prefix()} #{Fake.Person.It.first_name()}"
  defp city(1), do: "#{city_prefix()} #{Fake.Person.It.first_name()} #{city_suffix()}"
  defp city(2), do: "#{Fake.Person.It.first_name()} #{city_suffix()}"
  defp city(3), do: "#{Fake.Person.It.last_name()}"
  ...
  ## Examples
      ...
      iex> Fake.Address.It.city_prefix()
      "Quarto"
      iex> Fake.Address.It.city_prefix()
      "Castello"
      iex> Fake.Address.It.city_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Address.It.city_suffix()
      "di sotto"
      iex> Fake.Address.It.city_suffix()
      "di sopra"
      iex> Fake.Address.It.city_suffix()
  ...
  ## Examples
      ...
      iex> Fake.Address.It.country_code()
      "CO"
      iex> Fake.Address.It.country_code()
      "LV"
  """
  ...
  Return random secondary address.
    ...
    ## Examples
      ...
      iex> Fake.Address.It.secondary_address()
      "/A"
      iex> Fake.Address.It.secondary_address()
      "/B"
      iex> Fake.Address.It.secondary_address()
  ...
  def secondary_address do
    ...
    |> Enum.at(Fake.random_between(0, 4))
    |> Fake.format()
  end

  @doc """
  Return state. But Italy doesn't have states so this calls Fake.Address.It.region() instead
  """
  @spec state :: String.t()
  def state, do: region()
  ...
  something like ["Lombardia", "Milano", "MI"].
    ...
    ## Examples
      ...
      iex> Fake.Address.It.province_abbr()
      "BA"
      iex> Fake.Address.It.province_abbr()
      "TR"
      iex> Fake.Address.It.province_abbr()
  ...
  ## Examples
      ...
      iex> Fake.Address.It.region_province_abbr()
  ...
  Return street address.
    ...
    ## Examples
      ...
      iex> Fake.Address.It.street_address()
      "Corso Agave, 2"
      iex> Fake.Address.It.street_address()
      "Viale Keith, 083"
      iex> Fake.Address.It.street_address()
  ...
  Return `street_address/0` or if argument is `true` adds `secondary_address/0`.
    ...
    ## Examples
      ...
      iex> Fake.Address.It.street_address(true)
      "Corso Agave, 2/B"
      iex> Fake.Address.It.street_address(false)
  ...
  Return street name.
    ...
    ## Examples
      ...
      iex> Fake.Address.It.street_name()
      "Corso Agave"
      iex> Fake.Address.It.street_name()
  ...
  def street_name do
    street_name(Fake.random_between(0, 5))
  end

  defp street_name(0), do: "#{street_prefix()} #{Fake.Person.It.first_name()}"
  ...
  Return street prefix.
    ...
    ## Examples
      ...
      iex> Fake.Address.It.street_prefix()
      "Vicolo"
      iex> Fake.Address.It.street_prefix()
      "Corso"
      iex> Fake.Address.It.street_prefix()
