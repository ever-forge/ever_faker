defmodule Fake.Address.Hy do
  ...
  ## Examples
      ...
      iex> Fake.Address.Hy.building_number()
      "1"
      iex> Fake.Address.Hy.building_number()
      "4"
      iex> Fake.Address.Hy.building_number()
  ...
  ## Examples
      ...
      iex> Fake.Address.Hy.city_prefix()
      "ք."
  ...
  ## Examples
      ...
      iex> Fake.Address.Hy.secondary_address()
      "բն. 1"
      iex> Fake.Address.Hy.secondary_address()
      "բն. 4"
      iex> Fake.Address.Hy.secondary_address()
  ...
  ## Examples
      ...
      iex> Fake.Address.Hy.state_abbr()
      "ԱԳ"
      iex> Fake.Address.Hy.state_abbr()
      "ԱՐ"
      iex> Fake.Address.Hy.state_abbr()
  ...
  ## Examples
      ...
      iex> Fake.Address.Hy.street_address()
  ...
  ## Examples
      ...
      iex> Fake.Address.Hy.street_address(true)
      "Սուրբ Հովհաննեսի 542 բն. 4"
      iex> Fake.Address.Hy.street_address(false)
      "Գյուլբենկյան 0"
      iex> Fake.Address.Hy.street_address(true)
      "Պուշկինի 29 բն. 0"
      iex> Fake.Address.Hy.street_address(false)
  ...
  ## Examples
      ...
      iex> Fake.Address.Hy.street_name()
      "Սուրբ Հովհաննեսի"
      iex> Fake.Address.Hy.street_name()
      "Մոսկովյան"
      iex> Fake.Address.Hy.street_name()
  ...
  ## Examples
      ...
      iex> Fake.Address.Hy.street_suffix()
      "նրբանցք"
      iex> Fake.Address.Hy.street_suffix()
      "պողոտա"
      iex> Fake.Address.Hy.street_suffix()
