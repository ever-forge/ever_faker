defmodule Fake.Address.PtBr do
  import Fake, only: [sampler: 2]

  alias Fake.Person.PtBr
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.building_number()
      "s/n"
      iex> Fake.Address.PtBr.building_number()
      "5426"
      iex> Fake.Address.PtBr.building_number()
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.city_suffixes()
      "da Serra"
      iex> Fake.Address.PtBr.city_suffixes()
      "dos Dourados"
      iex> Fake.Address.PtBr.city_suffixes()
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.city_prefix()
      "Santo"
      iex> Fake.Address.PtBr.city_prefix()
      "Senador"
      iex> Fake.Address.PtBr.city_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.country_code()
      "BR"
  """
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.secondary_address()
      "Sala 154"
      iex> Fake.Address.PtBr.secondary_address()
      "Sala 646"
      iex> Fake.Address.PtBr.secondary_address()
  ...
  def secondary_address do
    ["Sala ###", "AP ###"]
    |> Enum.at(Fake.random_between(0, 1))
    |> Fake.format()
  end
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.neighborhood()
      "Granja De Freitas"
      iex> Fake.Address.PtBr.neighborhood()
      "Novo Ouro Preto"
      iex> Fake.Address.PtBr.neighborhood()
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.state_abbr()
      "RO"
      iex> Fake.Address.PtBr.state_abbr()
      "RS"
      iex> Fake.Address.PtBr.state_abbr()
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.street_address()
      "Estação Kaique, 2"
      iex> Fake.Address.PtBr.street_address()
      "Lagoa Matheus, 0832"
      iex> Fake.Address.PtBr.street_address()
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.street_address(true)
      "Estação Kaique, 2 Sala 461"
      iex> Fake.Address.PtBr.street_address(false)
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.street_name()
      "Estação Kaique"
      iex> Fake.Address.PtBr.street_name()
  ...
  def street_name do
    street_name(Fake.random_between(0, 2))
  end
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.street_prefix()
      "Recanto"
      iex> Fake.Address.PtBr.street_prefix()
      "Estação"
      iex> Fake.Address.PtBr.street_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.time_zone()
      "Australia/Sydney"
      iex> Fake.Address.PtBr.time_zone()
      "America/Guyana"
      iex> Fake.Address.PtBr.time_zone()
  ...
  ## Examples
      ...
      iex> Fake.Address.PtBr.zip_code()
      "15426461"
      iex> Fake.Address.PtBr.zip_code()
      "83297052"
      iex> Fake.Address.PtBr.zip_code()
