defmodule Fake.Address.En do
  ...
  ## Examples
      ...
      iex> Fake.Address.En.building_number()
      "15426"
      iex> Fake.Address.En.building_number()
      "6"
      iex> Fake.Address.En.building_number()
  ...
  ## Examples
      ...
      iex> Fake.Address.En.city_prefix()
      "Port"
      iex> Fake.Address.En.city_prefix()
      "West"
      iex> Fake.Address.En.city_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Address.En.city_suffix()
      "burgh"
      iex> Fake.Address.En.city_suffix()
      "mouth"
      iex> Fake.Address.En.city_suffix()
  ...
  ## Examples
      ...
      iex> Fake.Address.En.country_code()
      "IT"
      iex> Fake.Address.En.country_code()
      "MR"
      iex> Fake.Address.En.country_code()
  ...
  ## Examples
      ...
      iex> Fake.Address.En.secondary_address()
      "Apt. 154"
      iex> Fake.Address.En.secondary_address()
      "Apt. 646"
      iex> Fake.Address.En.secondary_address()
  ...
  ## Examples
      ...
      iex> Fake.Address.En.state_abbr()
      "HI"
      iex> Fake.Address.En.state_abbr()
      "AK"
      iex> Fake.Address.En.state_abbr()
  ...
  ## Examples
      ...
      iex> Fake.Address.En.street_address()
      "15426 Padberg Mews"
      iex> Fake.Address.En.street_address()
      "83297 Jana Spring"
      iex> Fake.Address.En.street_address()
  ...
  ## Examples
      ...
      iex> Fake.Address.En.street_address(true)
      "15426 Padberg Mews, Apt. 832"
      iex> Fake.Address.En.street_address(false)
      "7 Jana Spring"
      iex> Fake.Address.En.street_address(true)
  ...
  ## Examples
      ...
      iex> Fake.Address.En.street_name()
      "Elizabeth Freeway"
      iex> Fake.Address.En.street_name()
      "Sipes Trycia Glen"
      iex> Fake.Address.En.street_name()
  ...
  ## Examples
      ...
      iex> Fake.Address.En.street_suffix()
      "View"
      iex> Fake.Address.En.street_suffix()
      "Locks"
      iex> Fake.Address.En.street_suffix()
