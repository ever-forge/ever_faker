defmodule Fake.DateTime do
  ...
  ## Examples
      ...
      iex> Fake.DateTime.between(~N[2016-12-20 00:00:00], ~N[2016-12-25 00:00:00])
  ...
  defp unix_between(from, to) do
    ...
    date = from + sign * Fake.random_between(0, abs(diff))
