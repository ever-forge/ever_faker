defmodule Fake.Company.En do
  ...
  ## Examples
      ...
      iex> Fake.Company.En.bullshit_prefix()
      "syndicate"
      iex> Fake.Company.En.bullshit_prefix()
      "visualize"
      iex> Fake.Company.En.bullshit_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Company.En.bullshit_suffix()
      "e-services"
      iex> Fake.Company.En.bullshit_suffix()
      "niches"
      iex> Fake.Company.En.bullshit_suffix()
  ...
  ## Examples
      ...
      iex> Fake.Company.En.buzzword_prefix()
      "Configurable"
      iex> Fake.Company.En.buzzword_prefix()
      "Advanced"
      iex> Fake.Company.En.buzzword_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Company.En.buzzword_suffix()
      "encoding"
      iex> Fake.Company.En.buzzword_suffix()
      "standardization"
      iex> Fake.Company.En.buzzword_suffix()
  ...
  ## Examples
      ...
      iex> Fake.Company.En.catch_phrase()
  ...
  """
  @spec name() :: String.t()
  def name, do: name(Fake.random_between(0, 2))
