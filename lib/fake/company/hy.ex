defmodule Fake.Company.Hy do
  import Fake, only: [sampler: 2]

  alias Fake.Person.Hy, as: Person
  ...
  ## Examples
      ...
      iex> Fake.Company.Hy.bullshit_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Company.Hy.bullshit_suffix()
      "հարաբերություններ"
      iex> Fake.Company.Hy.bullshit_suffix()
      "շուկաներ"
      iex> Fake.Company.Hy.bullshit_suffix()
  ...
  ## Examples
      ...
      iex> Fake.Company.Hy.buzzword_prefix()
      "Բազմուղի"
      iex> Fake.Company.Hy.buzzword_prefix()
      "Կարգավորելի"
      iex> Fake.Company.Hy.buzzword_prefix()
  ...
  ## Examples
      ...
      iex> Fake.Company.Hy.buzzword_suffix()
      "ինտերֆեյս"
      iex> Fake.Company.Hy.buzzword_suffix()
      "համախմբվածություն"
      iex> Fake.Company.Hy.buzzword_suffix()
  ...
  ## Examples
      ...
      iex> Fake.Company.Hy.catch_phrase()
  ...
  """
  @spec name() :: String.t()
  def name, do: name(Fake.random_between(0, 4))
  defp name(0), do: "#{Fake.Address.Hy.city()} #{suffix()}"
