defmodule EverFaker.Internet.UserAgent do
  ...
  ## Examples
      ...
      iex> EverFaker.Internet.UserAgent.bot_user_agent()
  ...
  ## Examples
      ...
      iex> EverFaker.Internet.UserAgent.desktop_user_agent()
  ...
  ## Examples
      ...
      iex> EverFaker.Internet.UserAgent.ereader_user_agent()
  ...
  ## Examples
      ...
      iex> EverFaker.Internet.UserAgent.game_console_user_agent()
  ...
  ## Examples
      ...
      iex> EverFaker.Internet.UserAgent.set_top_user_agent()
  ...
  ## Examples
      ...
      iex> EverFaker.Internet.UserAgent.tablet_user_agent()
  ...
  ## Examples
      ...
      iex> EverFaker.Internet.UserAgent.mobile_user_agent()
  ...
  ## Examples
      ...
      iex> EverFaker.Internet.UserAgent.user_agent()
      "Mozilla/5.0 (Linux; Android 6.0; HTC One M9 Build/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Mobile Safari/537.36"
      iex> EverFaker.Internet.UserAgent.user_agent()
      "Mozilla/5.0 (compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm)"
      iex> EverFaker.Internet.UserAgent.user_agent()
