defmodule EverFaker.Avatar do
  ...
  ## Examples
      ...
      iex> EverFaker.Avatar.image_url()
  ...
  ## Examples
      ...
      iex> EverFaker.Avatar.image_url("faker")
      "https://robohash.org/faker"
      iex> EverFaker.Avatar.image_url("elixir")
      "https://robohash.org/elixir"
      iex> EverFaker.Avatar.image_url("plug")
      "https://robohash.org/plug"
      iex> EverFaker.Avatar.image_url("ecto")
  ...
  ## Examples
      ...
      iex> EverFaker.Avatar.image_url("phoenix", 100, 100)
      "https://robohash.org/phoenix?size=100x100"
      iex> EverFaker.Avatar.image_url("haskell", 200, 200)
      "https://robohash.org/haskell?size=200x200"
      iex> EverFaker.Avatar.image_url("ocaml", 300, 300)
      "https://robohash.org/ocaml?size=300x300"
      iex> EverFaker.Avatar.image_url("idris", 400, 400)
