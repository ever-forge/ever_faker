defmodule EverFaker.DateTime do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> EverFaker.DateTime.backward(4)
  ...
  ## Examples
      ...
      iex> EverFaker.DateTime.forward(4)
  ...
  ## Examples
      ...
      iex> EverFaker.DateTime.between(~N[2016-12-20 00:00:00], ~N[2016-12-25 00:00:00])
  ...
  defp unix_between(from, to) do
    ...
    date = from + sign * EverFaker.random_between(0, abs(diff))
