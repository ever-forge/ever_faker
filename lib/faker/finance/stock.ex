defmodule EverFaker.Finance.Stock do
  ...
  ## Examples
      ...
      iex> EverFaker.Finance.Stock.ticker()
      "7401.N225"
      iex> EverFaker.Finance.Stock.ticker()
      "4786.HK"
      iex> EverFaker.Finance.Stock.ticker()
  ...
  ## Examples
      ...
      iex> EverFaker.Finance.Stock.ticker(:reuters, :nikkei225)
      "2110.N225"
      iex> EverFaker.Finance.Stock.ticker(:reuters, :nikkei225)
      "7401.N225"
      iex> EverFaker.Finance.Stock.ticker(:reuters, :nikkei225)
      ...
      iex> EverFaker.Finance.Stock.ticker(:reuters, :nikkei225)
      "8304.N225"
      iex> EverFaker.Finance.Stock.ticker(:reuters, :sehk)
      "7564.HK"
      iex> EverFaker.Finance.Stock.ticker(:reuters, :sehk)
      "3609.HK"
      iex> EverFaker.Finance.Stock.ticker(:reuters, :sehk)
  ...
  def ticker(:reuters, :nikkei225) do
    "#{EverFaker.random_between(1000, 9999)}.N225"
  end

  def ticker(:reuters, :sehk) do
    stock_str =
      EverFaker.random_between(1, 8999)
      |> Integer.to_string()
