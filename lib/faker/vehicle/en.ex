defmodule EverFaker.Vehicle.En do
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.body_style()
      "Minivan"
      iex> EverFaker.Vehicle.En.body_style()
      "Hatchback"
      iex> EverFaker.Vehicle.En.body_style()
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.drivetrain()
      "4x2/2-wheel drive"
      iex> EverFaker.Vehicle.En.drivetrain()
      "4x4/4-wheel drive"
      iex> EverFaker.Vehicle.En.drivetrain()
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.fuel_type()
      "Ethanol"
      iex> EverFaker.Vehicle.En.fuel_type()
      "E-85/Gasoline"
      iex> EverFaker.Vehicle.En.fuel_type()
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.make_and_model()
      "Lincoln MKZ"
      iex> EverFaker.Vehicle.En.make_and_model()
      "Chevrolet Malibu"
      iex> EverFaker.Vehicle.En.make_and_model()
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.model()
      "Encore"
      iex> EverFaker.Vehicle.En.model()
      "S5"
      iex> EverFaker.Vehicle.En.model()
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.model("Ford")
      "Focus"
      iex> EverFaker.Vehicle.En.model("BMW")
      "X5"
      iex> EverFaker.Vehicle.En.model("Audi")
      "A4"
      iex> EverFaker.Vehicle.En.model("Toyota")
      "Corolla"
  """
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.option()
      "Premium Sound"
      iex> EverFaker.Vehicle.En.option()
      "Power Steering"
      iex> EverFaker.Vehicle.En.option()
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.options()
  ...
  def options do
    Util.list(EverFaker.random_between(2, 8), fn _ -> Util.pick(@options) end)
  end
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.options(3)
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.standard_spec()
      "Tire pressure monitoring system (TPMS)"
      iex> EverFaker.Vehicle.En.standard_spec()
      "20\\" x 9.0\\" front & 20\\" x 10.0\\" rear aluminum wheels"
      iex> EverFaker.Vehicle.En.standard_spec()
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.standard_specs()
  ...
  def standard_specs do
    Util.list(EverFaker.random_between(2, 8), fn _ -> Util.pick(@standard_specs) end)
  end
  ...
  ## Examples
      ...
      iex> EverFaker.Vehicle.En.transmission()
      "CVT"
      iex> EverFaker.Vehicle.En.transmission()
      "Automatic"
      iex> EverFaker.Vehicle.En.transmission()
