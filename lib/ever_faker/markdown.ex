defmodule EverFaker.Markdown do
  import EverFaker, only: [random_between: 2, random_uniform: 0]
  ...
  ## Examples
      ...
      iex> EverFaker.Markdown.headers()
      "###### Aliquam"
      iex> EverFaker.Markdown.headers()
      "### Sint"
      iex> EverFaker.Markdown.headers()
  ...
  ## Examples
      ...
      iex> EverFaker.Markdown.emphasis()
  ...
  ## Examples
      ...
      iex> EverFaker.Markdown.ordered_list()
  ...
  ## Examples
      ...
      iex> EverFaker.Markdown.unordered_list()
  ...
  ## Examples
      ...
      iex> EverFaker.Markdown.inline_code()
  ...
  ## Examples
      ...
      iex> EverFaker.Markdown.block_code()
      "```elixir\nDeleniti consequatur et qui vitae et.\n```"
      iex> EverFaker.Markdown.block_code()
      "```elixir\nAut expedita cumque est necessitatibus beatae ex sunt!\n```"
      iex> EverFaker.Markdown.block_code()
  ...
  ## Examples
      ...
      iex> EverFaker.Markdown.markdown()
