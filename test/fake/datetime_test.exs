defmodule Fake.DateTimeTest do
  use ExUnit.Case, async: true

  test "forward/1" do
    now = DateTime.utc_now()
    forwarded_date = Fake.DateTime.forward(10)
  ...
  test "backward/1" do
    now = DateTime.utc_now()
    backward_date = Fake.DateTime.backward(10)
  ...
  test "between/2 for Date.t" do
    ...
    to_date = Fake.DateTime.forward(50) |> DateTime.to_date()
    between_date = Fake.DateTime.between(from_date, to_date)
  ...
  test "between/2 for NaiveDateTime.t" do
    ...
    to_datetime = Fake.DateTime.forward(50)
    ...
    between_date = Fake.DateTime.between(from_naivedatetime, to_naivedatetime)
  ...
  test "between/2 for DateTime.t" do
    ...
    to_date = Fake.DateTime.forward(50)
    between_date = Fake.DateTime.between(from_date, to_date)
